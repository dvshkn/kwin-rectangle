...
shortcut('Eigth: (1) Top First', 'Alt+Q', 0, 1, 1, 2, 4)
shortcut('Eigth: (2) Top Second', 'Alt+W', 1, 1, 1, 2, 4)
shortcut('Eigth: (3) Top Third', 'Alt+E', 2, 1, 1, 2, 4)
shortcut('Eigth: (4) Top Fourth', 'Alt+R', 3, 1, 1, 2, 4)
shortcut('Eigth: (5) Bottom First', 'Alt+A', 4, 1, 1, 2, 4)
shortcut('Eigth: (6) Bottom Second', 'Alt+S', 5, 1, 1, 2, 4)
shortcut('Eigth: (7) Bottom Third', 'Alt+D', 6, 1, 1, 2, 4)
shortcut('Eigth: (8) Bottom Fourth', 'Alt+F', 7, 1, 1, 2, 4)
